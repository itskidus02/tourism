...
import logo from "../assets/icons/eth-bg-black.png";
      ...
      <nav className="bg-transparent  absolute top-0 left-0 w-full border-gray-200 px-4 lg:px-6 py-2.5 z-50">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center gap-3 lg:order-2">
            <Button
              href="#"
              className="bg-transparent ring-1 ring-slate-900 text-slate-900 hover:text-slate-900 hover:bg-white transition-all duration-300"
            >
              Log in
            </Button>
            <Button
          ...
          >
            <ul className="flex flex-row space-x-8 mt-0">
              ...
              <li>
                <a href="#todo" onClick={handleSmoothScroll} className="text-slate-900 hover:text-slate-300 transition-all duration-300">
                  Things to do
                </a>
              </li>
              <li>
                <a href="#ceremony" onClick={handleSmoothScroll} className="text-slate-900 hover:text-slate-300 transition-all duration-300">
                  Ceremonies
                </a>
              </li>
              <li>
                <a href="#destination" onClick={handleSmoothScroll} className="text-slate-900 hover:text-slate-300 transition-all duration-300">
                  Destination
                </a>
              </li>
              <li>
                <a href="#newsletter" onClick={handleSmoothScroll} className="text-slate-900  hover:text-slate-300 transition-all duration-300">
                  Newsletter
                </a>
              </li>
            </ul>
